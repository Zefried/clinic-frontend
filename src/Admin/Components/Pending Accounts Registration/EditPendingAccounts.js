...
export const EditPendingAccounts = () => {
  ...
  function updatingAdminDoctor(e) {
    ...
    try {
      ...
      axios.get('sanctum/csrf-cookie').then(response => {
        axios.post(`api/admin/update-pending-accounts-info/${id}`, docOldData, {
                    ...
                    {loading}
                        ...
                        <div className="row">
                            ...
                            {step === 1 && (
                                                ...
                                                {/* future reference - changed profession name key to designation due to ease of updating */}
                                                <select className="form-control" id="profession" name="designation" value={docOldData.designation || ""}  onChange={(e) => handleTest(e)} >
