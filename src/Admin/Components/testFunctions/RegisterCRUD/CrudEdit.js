                    ...
                    axios.get('sanctum/csrf-cookie').then(response => {
                        ...
                        .then((res) => {
                            if (res.data.status === 200) {
                                setExistingData(res.data.doc_data[0]); // Set form data with fetched doctor details
            ...
            function updateExistingData(e) {
                ...
                try {
                    ...
                    axios.get('sanctum/csrf-cookie').then(response => {
                        ...
                        axios.post(`api/admin/update-doctor/${id}`, existingData, {
                            headers: {
                                'Content-Type': 'application/json',
                                Authorization: `Bearer ${token}`
                            }
            ...
            let editMainForm = (
                <div className="container mt-5">
                        <div className="card shadow-lg border-0 rounded-4" id='doc-bg'>
                            ...
                            <h3 className="text-center mb-4">Insert Heading - Step {step}</h3>
                            {messages}
                            {loading}
                                ...
                                <div className="row">
                                    ...
                                    {step === 1 && (
                                                        ...
                                                        <select disabled className="form-control" id="profession" name="profession" value={existingData.user_type} onChange={handleChange} >
                                                        ...
                                                        <div className="form-floating mb-3 col-lg-6">
                                                            <input type="number" className="form-control" id="age" name="age" value={existingData.age} onChange={handleChange} placeholder="Age" />
                                                        ...
                                                        <div className="form-floating mb-3 col-lg-6">
                                                            <input type="text" className="form-control" id="sex" name="sex" value={existingData.sex} onChange={handleChange} placeholder="Sex" />
                                                        ...
                                                        <div className="form-floating mb-3 col-lg-6">
                                                            ...
                                                            id="relativeName" 
                                                            name="relativeName"
                                                            value={existingData.relativeName}
                                    ...
                                    {step === 3 && (
                                                        ...
                                                        <div className="form-floating mb-3 col-lg-6">
                                                            ...
                                                            id="workDistrict" 
                                                            name="workDistrict"
                                                            value={existingData.workDistrict}
                                                            onChange={handleChange}
                                                            placeholder="District" 
                                                            />
                                    ...
                                    <div className="d-flex justify-content-center">
                                        {step > 2 && ( <><button type="button" onClick={updateExistingData} className="btn btn-outline-primary col-md-3">Submit</button></>)}
                                    </div>
